import { faUsers, faDiagramProject, faListCheck } from "@fortawesome/free-solid-svg-icons";
            ...
            <div className="container">
                <ul className="nav nav-tabs nav-dark">
                    ...
                    <li className="nav-item navbar-dark">
                        <a className="nav-link text-light" href="#"><FontAwesomeIcon icon={faDiagramProject}/> Проекты</a>
                    </li>
                    <li className="nav-item">
